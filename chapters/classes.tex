...
\begin{figure}
    \subfigure{\includegraphics[width=3in]{figures/classes/basic_switch}}
    \subfigure{\includegraphics[width=3in]{figures/classes/basic_switch_waveform}}
...
\begin{figure}
    \subfigure{\includegraphics[width=3in]{figures/classes/classd_ckt}}
    \subfigure{{\raisebox{-0.25\height}{\includegraphics[width=3in,height=3in,keepaspectratio]{figures/classes/classd_wave}}}}
...
\begin{figure}
    \subfigure{\includegraphics[width=3in]{figures/classes/classe_ckt}}
    \subfigure{{\raisebox{-0.25\height}{\includegraphics[width=3in,height=3in,keepaspectratio]{figures/classes/classe_wave2}}}}
